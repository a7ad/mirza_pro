...
function show_animated_logo() {
    ...
    type_text_colored "\033[1;36m" "                    debugger:  github.com/a7ad/mirza_pro" 0.015
    echo ""
}
...
function install_bot() {
    ...
    ZIP_URL=$(curl -s https://api.github.com/repos/a7ad/mirza_pro/releases/latest | grep "zipball_url" | cut -d '"' -f 4)

if [[ "$1" == "-v" && "$2" == "beta" ]] || [[ "$1" == "-beta" ]] || [[ "$1" == "-" && "$2" == "beta" ]]; then
    ZIP_URL="https://github.com/a7ad/mirza_pro/archive/refs/heads/main.zip"
elif [[ "$1" == "-v" && -n "$2" ]]; then
    ZIP_URL="https://github.com/a7ad/mirza_pro/mirza_pro/archive/refs/tags/$2.zip"
fi
...
function install_bot_with_marzban() {
    ...
    if [[ "$1" == "-v" && "$2" == "beta" ]] || [[ "$1" == "-beta" ]] || [[ "$1" == "-" && "$2" == "beta" ]]; then
        ...
        ZIP_URL="https://github.com/a7ad/mirza_pro/archive/refs/tags/$2.zip"
    fi
 ...
 # Fallback to main branch if ZIP_URL is empty or invalid
  if [ -z "$ZIP_URL" ]; then
    ...
    if [ -n "$INSTALL_SCRIPT_PATH" ]; then
        ...
        RAW_INSTALL_URL="https://raw.githubusercontent.com/a7ad/mirza_pro/main/install.sh"
...
EOF"
    ...
    git clone https://github.com/a7ad/mirza_pro.git "$BOT_DIR" || {
...
function update_additional_bot() {
    ...
    if ! git clone https://github.com/a7ad/mirza_pro.git "$BOT_PATH"; then
